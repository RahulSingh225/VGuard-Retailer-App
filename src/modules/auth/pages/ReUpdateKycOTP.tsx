...
import { generateOtpForReverify, generateOtpForLogin, validateReverifyOtp } from "../../../utils/apiservice";
    ...
    const handleValidation = async () => {
        try {
            ...
            if (validationResponse.status === 200) {
                ...
                if (validationResponse.data.message == "Please enter OTP to proceed with the process") {
                    setotpsentflag(true);
                }
            } else {
                        ...
                        <View style={{ backgroundColor: 'transparent', height: 40, flexDirection: 'row', justifyContent: 'space-evenly', width: '80%', paddingTop: 10, alignSelf: 'center' }}>
                            ...
                            {countdown !== null && countdown > 0 ? (
                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    <Text style={{ fontSize: responsiveFontSize(1.8), paddingLeft: 5, paddingRight: 5, color: 'black' }}>in</Text>
